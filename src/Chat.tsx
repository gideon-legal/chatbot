                ...
                .then((res: any) => {
                    ...
                    for(i of messages){
                        if(i.sender_type === 'bot'){
                            if(i.entities && i.entities.length >= 1){
