...
export class SubmitButton extends React.Component<SubmitButtonProps, SubmitButtonState> {
  ...
  private setFocus(focus: boolean) {
    this.setState({isFocusing: focus});
  }
